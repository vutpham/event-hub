...
event4 = Event.create(title: "Imagine Dragons Evolve Tour",
                      ...
                      host_id: 1)
event4 = Event.create(title: "Bruno Mars: 24K Magic World Tour",
...
event5 = Event.create(title: "Ed Sheeran: The Divide World Tour",
...
event6 = Event.create(title: "Cazzette Live",
...
event7 = Event.create(title: "Chocolate and Art Show",
...
event8 = Event.create(title: "Fillmore Jazz Festival",
...
event9 = Event.create(title: "San Francisco Shakespeare Fesitval",
...
event10 = Event.create(title: "The Renegade Craft Fair",
